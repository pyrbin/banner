...
private:
    ...
    void createCommandQueues()
    {
        ...
        // Note: only command buffers for a single queue family can be created from this
        // pool
        ...
        for (uint32_t i = 0; i < swapChainImages.size(); i++) {
            ...
            // Note: previous layout doesn't matter, which will likely cause contents to
            // be discarded
            ...
            vkCmdPipelineBarrier(presentCommandBuffers[i], VK_PIPELINE_STAGE_TRANSFER_BIT,
                VK_PIPELINE_STAGE_TRANSFER_BIT, 0, 0, nullptr, 0, nullptr, 1,
                &presentToClearBarrier);

            vkCmdClearColorImage(presentCommandBuffers[i], swapChainImages[i],
    ...
    void draw()
    {
        ...
        // This is the stage where the queue should wait on the semaphore (it doesn't have
        // to wait with drawing, for example)
